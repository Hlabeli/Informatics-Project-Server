...
class UserSocialForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'linkedin': TextInput(attrs={'class': 'form-control form_inputs', 'required': False, 'placeholder': 'https://www.linkedin.com', 'name': 'linkedin'}),
            'twitter': TextInput(attrs={'class': 'form-control form_inputs', 'required': False, 'placeholder': 'https://twitter.com', 'name': 'twitter'}),
            'github': TextInput(attrs={'class': 'form-control form_inputs', 'required': False, 'placeholder': 'https://github.com', 'name': 'github'}),
            'youtube': TextInput(attrs={'class': 'form-control form_inputs', 'required': False, 'placeholder': 'https://www.youtube.com', 'name': 'youtube'}),
        }
