    ...
    if not request.user.is_authenticated:
        if request.method == 'GET':
            ...
            if signup_form.is_valid():
                ...
                social = UserSocial(user=user, linkedin="https://www.linkedin.com", twitter="https://twitter.com", youtube="https://www.youtube.com", github="https://github.com")
                social.save()
        ...
        try:
            ...
            if social_from.is_valid():
                ...
                if linkedin is not None:
                    ...
                    user_social.linkedin = "https://www.linkedin.com"

                if youtube is not None:
                    user_social.youtube = youtube
                else:
                    user_social.youtube = "https://www.youtube.com"

                if github is not None:
                    user_social.github = github
                else:
                    user_social.github = "https://github.com"

                if twitter is not None:
                    user_social.twitter = twitter
                else:
                    user_social.twitter = "https://twitter.com"
                ...
                return JsonResponse({"error": "Please enter valid URL for all fields. Example: https://www.linkedin.com"}, status=400)
